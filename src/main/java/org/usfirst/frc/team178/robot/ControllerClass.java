...
public class ControllerClass extends Joystick
{
    ...
    public JoystickButton rBumper = new JoystickButton(this, 6);
    public JoystickButton lBumper = new JoystickButton(this, 5);
    public JoystickButton startButton = new JoystickButton(this, 8);
    public JoystickButton backButton = new JoystickButton(this, 7);
